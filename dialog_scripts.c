...
/* =========================
    ...
    { "Her", "Well fortunately for me, it seems like you're juuuust not-terrible enough for me, which is good enough in my book!", EVENT_AVATAR_HIDE | EVENT_FADE_IN | EVENT_CHANGE_BACKGROUND, BG_BOOTH, AVATAR_NONE, SOUND_NONE, INSPECT_NONE, 0, {}, 39 },
